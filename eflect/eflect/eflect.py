...
from eflect.data.fake_rapl import sample_fake_rapl
...
class Eflect:
    ...
    def start(self):
        ...
        if not self.running:
            ...
            yappi.start()
            self.data_futures.append(self.yappi_executor.submit(self.__periodic_sample_threads))
    ...
    def __periodic_sample_threads(self):
...
def profile(workload, period=50):
